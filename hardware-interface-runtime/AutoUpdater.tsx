...
export const AutoUpdater = ({
  ...
  const checkerRef = useRef(new GitUpdateChecker());
  ...
  useEffect(() => {
    ...
    const checkAndUpdate = async () => {
      if (isChecking || updateInProgressRef.current) {
      ...
      try {
        ...
        if (!isClean) {
          ...
          logger.warn("Please commit or stash changes to enable auto-updates");
          return;
        }
